...
const ChatLanding: React.FC<ChatLandingProps> = ({ submitQuery, handlePresetReply }) => {
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative">
            ...
            <div className="relative h-20 flex items-center justify-center">
              <AnimatePresence mode="wait">
                <motion.h1
                  ...
                  className="absolute text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight leading-none bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 bg-clip-text text-transparent"
                  initial={{ 
                    opacity: 0, 
                    scale: 0.8,
                    rotateX: 90,
          ...
          {!mounted && (
            <div className="opacity-0">
              <h1 className="text-3xl font-bold">Explore My Work</h1>
            </div>
          )}
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        {/* Compact Badge */}
        <div className="inline-flex items-center px-3 py-1.5 bg-blue-100 dark:bg-blue-900/30 rounded-full text-blue-600 dark:text-blue-300 text-xs font-medium mb-2">
        ...
        <p className="text-gray-600 dark:text-gray-300 mx-auto max-w-lg text-sm sm:text-base leading-relaxed">
          Associate Product Manager with 3+ years of 0→1 experience across Fintech, Edtech and as a Founder. Navigate below to explore my work.
        </p>
      </motion.div>
      ...
      >
        <motion.div
          className="bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold rounded-full px-4 py-2 shadow-lg flex items-center gap-2 text-sm cursor-default max-w-fit mx-auto"
